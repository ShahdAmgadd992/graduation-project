...
import alexandriaHiddenGem from "../../assets/cities/alexandria.jpg";
      ...
      .then((results) => {
        const places = results.map((data, idx) => {
          ...
          return {
            ...
            image:
              best?.photo_url ||
              [[port], alexandria, luxor, aswan, marsaMatrouh][idx],
    ...
    <>
      ...
      <div className="packages-section">
        <div className="packages-content">
          ...
          <div
            className="packages-slider-wrapper"
        ...
        <div className="popular-content">
          ...
          <div className="destinations-row">
            {(hiddenGemPlaces.length > 0
              ? hiddenGemPlaces
              : [
                  { city: "Port Said", region: "North Coast", image: PortSaid },
                  {
                    city: "Alexandria",
                    region: "North Coast",
                    image: alexandria,
